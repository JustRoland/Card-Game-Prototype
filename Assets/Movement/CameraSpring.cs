...
namespace Movement
{
    ...
    {
        [Min(0.01f)] [SerializeField] private float halfLife = 0.1f;
        ...
        private static void Spring(ref Vector3 current, ref Vector3 velocity, Vector3 target, float halfLife, float frequency,
            float timeStep)
        {
